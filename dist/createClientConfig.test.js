...
var _createClientConfig = require('./createClientConfig');

var _createClientConfig2 = _interopRequireDefault(_createClientConfig);
...
describe('createClientConfig()', function () {

  it('should merge extra webpack config', function () {

    var config = (0, _createClientConfig2.default)((0, _extendDefaultConfig2.default)({
...
//# sourceMappingURL=createClientConfig.test.js.map